            ...
            <div className="flex flex-wrap gap-3 mt-2">
              {channels.map((channel) => (
                <a
                  ...
                  id={`contact-channel-${channel.type}`}
                  className="flex items-center gap-2.5 px-4 py-2 border border-border rounded-full hover:bg-muted hover:border-accent/30 transition-all group shadow-sm bg-background/50"
                >
