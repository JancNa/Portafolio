...
export const PROJECT_OVERRIDES: Record<string, string> = {
  ...
  'segmentacion': 'https://fmigvcjlgrhgicyawiyq.supabase.co/storage/v1/object/sign/Assets/file_000000001d6071f5867b24619023adb5.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV9iMzI1NDE1Mi1hMjA5LTRhOWUtYWQxYS05ZDYxMTI1ZDc5NmUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJBc3NldHMvZmlsZV8wMDAwMDAwMDFkNjA3MWY1ODY3YjI0NjE5MDIzYWRiNS5wbmciLCJpYXQiOjE3Nzk0MjExMTcsImV4cCI6MTgxMDk1NzExN30.E7LT46FCvKRMMbb-OjpSd357ZCjzPfCo6van7BrxF8A',
  'whatsapp': 'https://fmigvcjlgrhgicyawiyq.supabase.co/storage/v1/object/sign/Assets/file_000000003c7c720e9619fb00eb619b2c.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV9iMzI1NDE1Mi1hMjA5LTRhOWUtYWQxYS05ZDYxMTI1ZDc5NmUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJBc3NldHMvZmlsZV8wMDAwMDAwMDNjN2M3MjBlOTYxOWZiMDBlYjYxOWIyYy5wbmciLCJpYXQiOjE3Nzk0MjE5MTcsImV4cCI6MTgxMDk1NzkxN30.Awp6m-igjkGxbkgdAaOcmq1dXDogeNwHi8kGM9iCWBY'
};
...
export function patchProject(project: any) {
  ...
  if (title.includes('whatsapp') && PROJECT_OVERRIDES['whatsapp']) {
    return { ...project, cover_url: PROJECT_OVERRIDES['whatsapp'] };
  }
  ...
  if ((title.includes('segmentaci') || title.includes('segmentad') || title.includes('campaa') || title.includes('campaña')) && PROJECT_OVERRIDES['segmentacion']) {
    return { ...project, cover_url: PROJECT_OVERRIDES['segmentacion'] };
  }
